        ...
        <div id='services' className='py-16'>
            <div className='m-auto space-y-16 px-6 text-gray-500 xl:container md:px-12'>
                ...
                <div className='mt-16 grid gap-8 sm:grid-cols-2 md:-mx-8 lg:grid-cols-3 lg:gap-0 xl:grid-cols-4'>
                    <ServiceCard icon={<Edit3 />} iconHeaderText={'Intelligent Summarization'} iconHeaderDesc={'Automatically generate concise summaries of your notes using advanced AI algorithms.'} />
                    <ServiceCard icon={<Mic />} iconHeaderText='Voice to Text' iconHeaderDesc='Convert your spoken words into text, making
